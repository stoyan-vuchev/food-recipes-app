...
fun RecipeGridItemSaveButton(
    ...
    Button(
        ...
        content = {
            ...
            Spacer(modifier = Modifier.width(ComponentsTokens.Button.horizontalPadding * 0.75f))
            ...
            Spacer(modifier = Modifier.width(ComponentsTokens.Button.horizontalPadding * 0.25f))
